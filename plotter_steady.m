...
function plotter_steady(plotfigure,CC,i_xcoord,i_ycoord,R,i_id,i_type,v_LESC,t)
...
if plotfigure == 1
        ...
        plot(vMGFx,vMGFy,'b','LineWidth', 2)
        axis(R*[-1 1 -1 1])
        ...
        for i_cell = 1:number_of_cells
            % if (CC(i_cell,i_type) == 1)&(CC(i_cell,i_id) == 2)
            % if (CC(i_cell,i_type) == 1)
